...
// @grant        none
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/constants.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/game-database.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/database-loader.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/efficiency-calculator.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/item-data-engine.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/api-handler.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/state-manager-enhanced.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/ui-manager-enhanced.js
// @require      https://cdn.jsdelivr.net/gh/Seisen99/Degen-Idle-XP-Tracker@b64a113/v3/modules/optimizer.js
// ==/UserScript==
...
(function() {
    ...
    console.log('═══════════════════════════════════════════════════════');
    console.log('🚀 Degen Idle XP Tracker v3.0.47 - Auto Mode V2');
    console.log('═══════════════════════════════════════════════════════');
    console.log('Loading modules from CDN...');
    console.log('  ✅ NEW: Alchemy, Cooking, Woodcrafting, Crafting');
    console.log('  ✅ NEW: Cross-skill XP tracking');
    console.log('  ✅ NEW: Detailed progression steps');
    console.log('═══════════════════════════════════════════════════════');
    
    async function init() {
        console.log('[INIT] Starting XP Tracker v3.0.47...');
